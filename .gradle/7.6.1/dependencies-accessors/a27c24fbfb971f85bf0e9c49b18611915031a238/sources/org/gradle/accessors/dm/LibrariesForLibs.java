...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FoundationLibraryAccessors laccForFoundationLibraryAccessors = new FoundationLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at foundation
     */
    public FoundationLibraryAccessors getFoundation() { return laccForFoundationLibraryAccessors; }
    ...
    public static class FoundationLibraryAccessors extends SubDependencyFactory {
        private final FoundationLayoutLibraryAccessors laccForFoundationLayoutLibraryAccessors = new FoundationLayoutLibraryAccessors(owner);

        public FoundationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for android (androidx.compose.foundation:foundation-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("foundation.android"); }

        /**
         * Returns the group of libraries at foundation.layout
         */
        public FoundationLayoutLibraryAccessors getLayout() { return laccForFoundationLayoutLibraryAccessors; }

    }

    public static class FoundationLayoutLibraryAccessors extends SubDependencyFactory {

        public FoundationLayoutLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for android (androidx.compose.foundation:foundation-layout-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("foundation.layout.android"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: foundationAndroidVersion (1.6.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFoundationAndroidVersion() { return getVersion("foundationAndroidVersion"); }

            /**
             * Returns the version associated to this alias: foundationLayoutAndroidVersion (1.6.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFoundationLayoutAndroidVersion() { return getVersion("foundationLayoutAndroidVersion"); }
            ...
            /**
             * Returns the version associated to this alias: material3 (1.3.0-alpha03)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
